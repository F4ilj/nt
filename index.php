    ...
    <div class="container">
        <div class="row">
            ...
            <div class="list-group">
					<h3>Тип</h3>
					<?php
                    $query = "SELECT DISTINCT(typething) FROM components WHERE product_status = '1' ORDER BY typething DESC";
                    ...
                    <div class="list-group-item checkbox">
                        <label><input type="checkbox" class="common_selector typething" value="<?php echo $row['typething']; ?>"  > <?php echo $row['typething']; ?></label>
                    </div>
                    <?php
                    }
                    ?>	
...
function filter_data()
{
    ...
    $.ajax({
        url:"fetch_data.php",
        method:"POST",
        data:{action:action, minimum_price:minimum_price, maximum_price:maximum_price, kind:kind, typething:typething, storage:storage},
